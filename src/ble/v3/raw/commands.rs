...
/// This command is sent when the user taps the button to add a pawprint in the app.
///
/// When a pawprint is successfully added, the coyote will respond with an 0x01 notification.
